...
import 'package:movie_bloc/data/model/genre.dart';
import '../data/model/api_result_model.dart';
import '../screen/movie_detail_screen.dart';



class MovieOverViewItem extends StatelessWidget {
  final List<Results> movies;
  MovieOverViewItem(this.movies);

  void goToDetailPage(BuildContext context,Results movies){
          ...
          return Container(
           ...
           children: <Widget>[
             ...
             Positioned(
               ...
               width: height * 0.16,
               child: InkWell(
                 onTap: () => goToDetailPage(context, movies[index]),
                 child: Hero(
                   tag:
